...
- Left-click a chest with empty hands to pick it up.
...
Only the host can pick up or place carried chests in multiplayer for now.

## Limitations

Only normal player chests are supported right now.
